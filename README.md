# rust-ssr-demos organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`rust-ssr-demos`](https://github.com/rust-ssr-demos).

## Canonical organization links

- GitHub organization: https://github.com/rust-ssr-demos
- Public organization defaults: https://github.com/rust-ssr-demos/.github
- Canonical Linear project: https://linear.app/denman/project/githubcomrust-ssr-demos-4aff6fcef4d4
...
`rust-ssr-demos` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
